    ...
    <>
      ...
      <div className="flex min-h-screen flex-col font-sans">
        {/* Degradado de marca: naranja a la izquierda, rojo a la derecha.
            Arranca en el naranja oscuro (#BD5407) y no en el claro: con el
            claro la bajada en blanco quedaba en 3.5:1 y el mínimo legible es
            4.5:1. Así el punto más flojo del degradado da 4.57:1 y todo el
            texto se lee, también al sol y con baja visión.
            El texto va en blanco puro, sin transparencias: cualquier
            opacidad encima del naranja vuelve a bajar del mínimo. */}
        <header className="bg-gradient-to-r from-alertaOscuro to-acento text-white">
